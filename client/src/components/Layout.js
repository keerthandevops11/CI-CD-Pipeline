    ...
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          ...
          <div>
            <h1 className="brand-title">DevOps Learning</h1>
            <p className="nav-subtitle">Learner Management</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to DevOps Learning 🚀" />
      <div className="app-body">
        <aside className="sidebar slide-in-left">
          <h3>Connect</h3>
          <ul className="social-links">
              <li><a className="sidebar-btn" href="https://www.linkedin.com/in/p-keerthan-prabhu-aa9b48293/" target="_blank" rel="noopener noreferrer">LinkedIn (Keerthan Prabhu)</a></li>
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} DevOps Learning.</p>
      </footer>
